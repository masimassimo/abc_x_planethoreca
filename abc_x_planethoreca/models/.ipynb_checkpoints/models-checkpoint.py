...
class ResPartner(models.Model):
    ...
    ''' DA SISTEMARE
    def invioDatiPSFornitore(self, idOdoo, firstname, lastname):
        
        apiPS = PrestashopApi('https://stage.planethoreca.it:443/api', 'A5WBAUB6TF2CRGCTR29HGAXMKQ19I4D4')
        #res=apiPS.get('suppliers?filter[id_odoo]=['+str(idOdoo)+']')
        #print(dict(res)['suppliers'])
        ...
        if(idPresta!=0):
            ...
            data = {'supplier': {'active': 1, 'name': name, 'link_rewrite':link}}
            print(apiPS.add('suppliers', data)['supplier'])'''
...
class ProductTemplate(models.Model):
    ...
    def invioDatiPS(self, idOdoo, name, categ, idsCategorie, price, riferimento, tasse, barcode, peso, width, height, depth, unita):
        apiPS = PrestashopApi('https://stage.planethoreca.it:443/api', 'A5WBAUB6TF2CRGCTR29HGAXMKQ19I4D4')
